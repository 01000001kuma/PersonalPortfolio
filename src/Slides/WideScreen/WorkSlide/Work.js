  ...
  constructor(props) {
    ...
    this.workDetails = [
      ...
      },
      {
        number: '01',
        projectName: 'IMentor',
        projectDesc: 'IMentor is a project developed in React and its ecosystem to help students to get in touch with senior students and help each other in this challenging journey to become a software developer.',
      ...
      },
      {
        ...
        projectType: 'Javascript Node.js Express.js',
